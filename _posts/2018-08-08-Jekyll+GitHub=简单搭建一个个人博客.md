...
![Files](/assets/image/Jekyll-1.png)
...
![_config.yml](/assets/image/Jekyll-2.png)
...
![site preview](/assets/image/Jekyll-3.png)
...
![settings menu](/assets/image/Jekyll-4.png)
...
![GitHub Pages settings](/assets/image/Jekyll-5.png)

-   Gitee

选择菜单中的 `服务` 。

![服务-码云 Pages ](/assets/image/Jekyll-6.png)

进入 `码云 Pages` 页面。并在下方选中 master 分支，点击部署。部署完成后同样会给出一个链接。点开就是架好的博客了。

![码云  Pages ](/assets/image/Jekyll-7.png)
